...
- **Duty management** — assign, track, and complete member duties
...
- **Laravel REST API** backend (HUDYAT API)
...
- A running instance of the HUDYAT Laravel backend
...
lib/
├── main.dart
├── providers/        # Auth, Event, Duty state management
├── screens/
│   ├── auth/         # Login screen
